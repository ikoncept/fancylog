...
var FancyLog = /*#__PURE__*/function () {
  function FancyLog() {
    var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

    _classCallCheck(this, FancyLog);

    this.loggers = (0, _lodash.default)(this.defaults, options);
  }

  _createClass(FancyLog, [{
    key: "defaults",
    get: function get() {
      return {
        'default': {
    ...
    value: function print() {
      ...
      var tailArguments = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
      ...
      console.log("%c ".concat(title, " %c ").concat(message, " %c"), "background:".concat(logger.badgeBackground, " ; padding: 1px; border-radius: 3px 0 0 3px;  color: ").concat(logger.badgeText), "background:".concat(logger.background, " ; padding: 1px; border-radius: 0 3px 3px 0;  color: ").concat(logger.text), "background:transparent");

      if (tailArguments && tailArguments.length) {
        var _console;

        (_console = console).log.apply(_console, _toConsumableArray(tailArguments));
      }
    }
  }, {
    key: "log",
...
},{"lodash.merge":"../node_modules/lodash.merge/index.js"}],"demo.js":[function(require,module,exports) {
"use strict";
...
console.log("\n Other examples");
logger = new _src.default();
logger.log("log", "Trailing arguments - arrays", ['Never gonna give you up, never gonna let you down', 'Never gonna run around and desert you', 'Never gonna make you cry, never gonna say goodbye', 'Never gonna tell a lie and hurt you'], ['Rick', 'Astley']);
